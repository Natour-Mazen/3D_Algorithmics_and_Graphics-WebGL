...
doc.addEventListener('DOMContentLoaded', () => {
    const scripts = [
        ...
        'src/objects/geometricObjects/boundingBox/BoundingBoxBorderTypes.js',
        'src/objects/geometricObjects/boundingBox/boundingBox.js',
        'src/objects/geometricObjects/boundingBox/boundingBoxRM.js',
        'src/objects/geometricObjects/boundingBox/boundingBoxVRC.js',
